<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div class="group bg-white rounded-xl border border-slate-200 shadow-sm p-5 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 relative overflow-hidden">
            <div class="absolute top-0 right-0 w-28 h-28 bg-violet-500/[0.04] rounded-full -translate-y-10 translate-x-10"></div>
            <div class="relative flex items-start justify-between mb-3">
                ...
                <span class="text-[11px] font-semibold text-violet-600 bg-violet-50 px-2 py-0.5 rounded-md">Total</span>
            </div>
            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider">UKM</p>
            <p class="text-3xl font-bold text-slate-800 mt-1">{{ $totalUkm }}</p>
        </div>
